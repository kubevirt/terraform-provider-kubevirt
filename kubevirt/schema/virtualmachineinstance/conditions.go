...
func virtualMachineInstanceConditionsSchema() *schema.Schema {
	fields := virtualMachineInstanceConditionsFields()
...
func expandVirtualMachineInstanceConditions(conditions []interface{}) ([]kubevirtapiv1.VirtualMachineInstanceCondition, error) {
	result := make([]kubevirtapiv1.VirtualMachineInstanceCondition, len(conditions))
	...
	for i, condition := range conditions {
		...
		if v, ok := in["type"].(string); ok {
			result[i].Type = kubevirtapiv1.VirtualMachineInstanceConditionType(v)
		}
...
func flattenVirtualMachineInstanceConditions(in []kubevirtapiv1.VirtualMachineInstanceCondition) []interface{} {
